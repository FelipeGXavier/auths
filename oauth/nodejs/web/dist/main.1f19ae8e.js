...
var reference = document.getElementById("container");
...
loginBtn.addEventListener('click', function login(event) {
  ...
  fetch("".concat(API_URL, "/login"), {
    ...
    reference.innerHTML = (0, _dashboard.renderDashboardPage)();
  }).catch(function (err) {
    return alert('Erro ao efetuar Login');
  });
});
},{"./dashboard.js":"dashboard.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
